...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/claude-code-account-pool/profile-snapshots", s.mgmt.ListClaudeCodeProfileSnapshots)
		mgmt.POST("/claude-code-account-pool/profile-snapshots/fetch", s.mgmt.FetchClaudeCodeProfileSnapshot)
		mgmt.GET("/claude-code-account-pool/profile-snapshots/:id", s.mgmt.GetClaudeCodeProfileSnapshot)
		mgmt.POST("/claude-code-account-pool/profile-snapshots/:id/diff", s.mgmt.DiffClaudeCodeProfileSnapshot)
		mgmt.POST("/claude-code-account-pool/profile-snapshots/:id/promote", s.mgmt.PromoteClaudeCodeProfileSnapshot)
		...
		mgmt.GET("/claude-code-account-pool/log-config", s.mgmt.GetClaudeCodePoolLogConfig)
		mgmt.PUT("/claude-code-account-pool/log-config", s.mgmt.PutClaudeCodePoolLogConfig)
		mgmt.PATCH("/claude-code-account-pool/log-config", s.mgmt.PutClaudeCodePoolLogConfig)
		mgmt.GET("/claude-code-account-pool/logs", s.mgmt.ListClaudeCodePoolLogs)
		mgmt.POST("/claude-code-account-pool/logs/clear", s.mgmt.ClearClaudeCodePoolLogs)
		mgmt.GET("/claude-code-account-pool/logs/download", s.mgmt.DownloadClaudeCodePoolLog)
