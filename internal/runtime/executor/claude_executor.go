...
//
// It operates on tools[].name, tool_choice.name, and tool_use/tool_reference
// references in messages. The returned map is keyed on the upstream fake name
// and maps back to the client-supplied original name.
